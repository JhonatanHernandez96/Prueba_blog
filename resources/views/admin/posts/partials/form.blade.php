...
<div class="row mb-3">
    <div class="col">
        <div class="image-wrapper">
            ...
            @else 
                <img id="picture" src="https://cdn.pixabay.com/photo/2020/05/18/18/00/doctor-5187731_960_720.png" alt="">
    ...
    <div class="col">
        ...
        <p>Solo se Aceptan imagenes</p>

    </div>
</div>

<div class="form-group">
    {!! Form::label('extract', 'Encabezado:') !!}
